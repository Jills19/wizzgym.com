    ...
    <>
      ...
      <footer className='bg-black  w-screen overflow-hidden'>
        <div>
              ...
              <div className='flex flex-col'>
                <ul className='text-sm md:mr-4 text-[#fdfdfddb]   flex flex-row   md:w-4/5 gap-3 '>
                  <li className='flex   items-center'>
                    <Link
                      href={"/gymrules"}
                      className='text-center whitespace-nowrap  hover:underline block   active:text-primary focus:text-primary hover:text-primary'
                    >
                      Gym Rules
                    </Link>
                  </li>
                  <li className='flex   items-center'>
                    <Link
                      href={"/community"}
                      className=' text-center md:w-fit hover:underline block   active:text-primary focus:text-primary hover:text-primary'
                    >
                      Community
                    </Link>
                  </li>
                  <li className='flex   items-center'>
                    <Link
                      ...
                      className=' flex-1 whitespace-nowrap  text-center md:w-fit hover:underline block   active:text-primary focus:text-primary hover:text-primary'
                    >
          ...
          <div className='w-full p-6 text-center bg-secondary'>
            <span className='w-full text-sm text-white sm:text-center'>
              ©{" "} {now.getFullYear()} {" "}
